...
if not oper or not arg1 or not arg3:
	print("Parameters are not correct1")
	print(arg1)
	print(oper)
	print(arg3)
	exit(0)
...
if len(oper) != 1:
    print("Parameters are not correct2")
    exit(0)
...
if oper not in "+-/*^r":
    print("Parameters are not correct3")
    exit(0)
if arg1[0] in '-+':
    if not arg1[1:].isdigit():
        print("Parameters are not correct4")
        exit(0)
elif not arg1.isdigit():
        print("Parameters are not correct5")
        exit(0)
if arg3[0] in '-+':
    if not arg3[1:].isdigit():
        print("Parameters are not correct6")
        exit(0)
elif not arg3.isdigit():
        print("Parameters are not correct7")
        exit(0)
